...
val generateBuildInfo by tasks.registering {
    ...
    val serverUrl =
        providers.gradleProperty("yellowtrack.serverUrl").orNull ?: "http://localhost:8080"
    ...
    doLast {
        ...
        target.resolve("BuildInfo.kt").writeText(
             ...
             *
             * Set the server with `-Pyellowtrack.serverUrl=https://…` at build time; the
             * default is the loopback address a development server listens on, which is
             * useless on any device that is not the machine running it.
             */
            object BuildInfo {
