...
- ◐ Add and edit client, project, and session — a client can be taken on and a booking
  opened against it, which makes the money layer reachable. Sessions, and editing an
  existing record, are still to come
